...
//Route.post('staff/registrationteste', 'Staff/RegistrationController.storeteste').validator('Staff/Registration')
...
//Route.resource('cadastroaluno','Staff/AlunosstaffController')
